...
def generateReport(path):
    ...
    output(bcolors.OKBLUE + f'> Here is the document:' + bcolors.ENDC, newline=False)
                ...
                if fileExtension == '.txt' or fileExtension == '.pdf':
                    ...
                    with open(os.path.join(os.getcwd(), 'saved', 'report.txt'), 'w') as report:
                        ...
                        with open(os.path.join(os.getcwd(), 'saved', 'report.txt'), 'r') as readerFile:
                            ...
                            removeDir = ['report.txt', secure_filename(uploaded_file.filename)]
                            for i in removeDir:
                                os.remove(os.path.join(os.getcwd(), 'saved', i))

                            return send_file(os.path.join(os.getcwd(), 'saved', 'report.pdf'), attachment_filename='report.pdf')
        else:
